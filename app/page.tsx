    ...
    <div className="bg-[#FDFAF5] min-h-screen">
      ...
      <section className="max-w-5xl mx-auto px-6 pt-16 pb-24 text-center">
        ...
        <div className="inline-flex items-center gap-2 bg-amber-50 border border-amber-200 text-amber-700 text-xs font-medium px-4 py-1.5 rounded-full mb-8">
          🎙️ Livré automatiquement chaque semaine par email
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={step.num} className="relative">
                <div className={`${step.couleur} rounded-3xl p-7`}>
                  <div className="text-4xl mb-4">{step.icon}</div>
                  <p className="text-xs font-bold text-gray-300 mb-2">{step.num}</p>
      ...
      <section className="py-20 px-6 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {[
            { emoji: "🎂", titre: "Anniversaire", desc: "Les 40 ans, les 70 ans, tous les âges méritent d'être célébrés en voix." },
            { emoji: "💍", titre: "Mariage", desc: "Un cadeau de mariage qui touche au cœur, bien après la fête." },
            { emoji: "🌅", titre: "Retraite", desc: "Une carrière, des souvenirs, des voix qui disent merci." },
            { emoji: "👶", titre: "Naissance", desc: "Les premiers mots du monde pour accueillir un nouveau venu." },
            { emoji: "✈️", titre: "Départ", desc: "Pour ceux qui s'en vont loin — une valise de voix familières." },
            { emoji: "🎉", titre: "Autre occasion", desc: "Chaque moment qui mérite d'être gravé dans les mémoires." },
          ].map((occ) => (
            <div key={occ.titre} className="bg-white border border-gray-100 rounded-2xl p-5 hover:shadow-md transition-shadow">
              ...
              <h3 className="font-semibold text-gray-900 mt-3 mb-1">{occ.titre}</h3>
      ...
      <section className="bg-gray-900 text-white py-20 px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <blockquote className="text-2xl md:text-3xl font-medium leading-relaxed mb-6">
            &ldquo;Une photo, ça montre un visage. Une voix, ça rappelle une personne entière.&rdquo;
          </blockquote>
      ...
      <footer className="border-t border-gray-100 py-8 px-6">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          ...
          <p className="text-xs text-gray-400">Fait avec ❤️ pour les moments qui comptent</p>
        </div>
      </footer>
